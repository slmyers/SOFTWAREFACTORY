...
async def test_persistence_db_roundtrip_or_skip(thread_id):
    """Save -> load roundtrip against Postgres. Skips when DATABASE_URL is not set or unreachable."""
    ...
    try:
        ...
        pytest.skip(f"Postgres unreachable; skipping DB integration test: {exc}")
